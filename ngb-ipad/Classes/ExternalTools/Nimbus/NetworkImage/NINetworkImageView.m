...
- (void)_didFinishLoadingWithImage:(UIImage *)image
  ...
  int length = [cacheIdentifier length] - 3;
  NSString *cache = [cacheIdentifier substringFromIndex:length];
  if ([cache isEqualToString:@"768"]) {
    [[NSNotificationCenter defaultCenter] postNotificationName:NOTIFICATION_HIDE_POSTER_LOADER object:nil];
  }
